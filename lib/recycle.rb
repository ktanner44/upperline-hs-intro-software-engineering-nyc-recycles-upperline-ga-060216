...
first_recycle_bin =  {"address"=>"E 227 St/Bronx River Pkway", "site_type"=>"Subproperty", "longitude"=>"-73.864223918", "borough"=>"Bronx", "latitude"=>"40.890848989", "park_site_name"=>"227th St. Plgd"}
...
def all_keys(first_recycle_bin)
  first_recycle_bin.each_key do |key|
    puts "#{key}"
  end
end
...
def all_data(first_recycle_bin)
  first_recycle_bin.each_value do |value|
    puts "#{value}"
  end
end
